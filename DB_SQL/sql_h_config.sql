...
ALTER TABLE h_config ADD COLUMN h_tradeex_test_api_key varchar(256) NULL COMMENT '用于测试的场外交易系统的API KEY';
ALTER TABLE h_config ADD COLUMN h_tradeex_test_api_secret varchar(256) NULL COMMENT '用于测试的场外交易系统的API SECRET';
ALTER TABLE h_config ADD COLUMN h_tradeex_cnyf_address varchar(256) NOT NULL DEFAULT COMMENT '用于把提现的金额转给场外交易的地址';
