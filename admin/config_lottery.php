...
<form action="?clause=saveeditinfo" method="post" name="addinfo">
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
    ...
    <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
      ...
      <td>每一次 <input name="h_point2Lottery" type="text" class="inputclass1" maxlength="8" value="<?php echo $rs['h_point2Lottery']; ?>" /> 积分</td>
    </tr>
    <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    ...
    <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
      ...
      <td>万分之 <input name="h_lottery4" type="text" class="inputclass1" maxlength="8" value="<?php echo $rs['h_lottery4']; ?>" /> （20元）</td>
    </tr>
    <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
      <td align="center">五等奖中奖概率</td>
      <td>万分之 <input name="h_lottery5" type="text" class="inputclass1" maxlength="8" value="<?php echo $rs['h_lottery5']; ?>" /> （8元）</td>
    </tr>
    <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
