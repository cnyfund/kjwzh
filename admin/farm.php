...
{
	global $db,$id;
	global $h_title,$h_pic,$h_point2Day,$h_money,$h_minMemberLevel,$h_info,$h_addTime,$cjfh;
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
  <tr>
    <td height="25" colspan="2" align="center" class="tdtitle">修改物品</td>
  </tr>
  ...
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">总共发行</td>
    <td><input name="h_allMaxNum" type="text" class="inputclass1" maxlength="25" value="<?php echo $rs['h_allMaxNum']; ?>" /> 只
    <font color="#ff0000">*</font></td>
  </tr>
    <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">出局获利</td>
    <td><input name="cjfh" type="text" class="inputclass1" maxlength="25" value="<?php echo $rs['cjfh']; ?>" /> 元
    <font color="#ff0000">*</font></td>
  </tr>
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
  <tr>
    <td height="25" colspan="2" align="center" class="tdtitle">添加物品</td>
  </tr>
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td width="20%" align="center">标题</td>
  ...
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">总共发行</td>
    <td><input name="h_allMaxNum" type="text" class="inputclass1" maxlength="25" value="" /> 只
    <font color="#ff0000">*</font></td>
  </tr>
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
  <tr>
    <td height="25" colspan="11" align="center" class="tdtitle">理财套餐设置</td>
  </tr>
  <tr align="center"> 
...
每天分红：<?php echo $val['h_point2Day']; ?><br />
生命周期：<?php echo $val['h_life']; ?><br />
售价：<?php echo $val['h_money']; ?><br />
排序：<?php echo get_member_level_span($val['h_minMemberLevel']); ?><br />
每月限购：<?php echo $val['h_dayBuyMaxNum']; ?><br />
总共发行：<?php echo $val['h_allMaxNum']; ?><br /></td>
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
  ...
  <tr> 
    <td height="23" class="tdbottom" align="center"><a href="?clause=addinfo">添加物品</a> | <a href="?">物品管理</a></td>
  </tr>
  <tr> 
...
<?php
	...
	?>
<input name="keyword" placeholder="物品名称" value="<?php echo $keyword;?>" type="text" />
