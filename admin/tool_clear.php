...
<input name="member" type="radio" value="2" id="member2" /><label for="member2">不清空会员，重置会员激活币和元为0</label><br />
<input name="member" type="radio" value="3" id="member3" /><label for="member3">保持会员不动</label><br />
<input name="dbs[]" type="checkbox" value="h_member_farm" id="h_member_farm" /><label for="h_member_farm">清空会员购买的物品</label><br />
...
<input name="dbs[]" type="checkbox" value="h_point2_sell" id="h_point2_sell" /><label for="h_point2_sell">清空会员拍卖元数据</label><br />
<input name="dbs[]" type="checkbox" value="h_withdraw" id="h_withdraw" /><label for="h_withdraw">清空会员提现申请</label><br />
<input name="dbs[]" type="checkbox" value="t_log_login_member" id="t_log_login_member" /><label for="t_log_login_member">清空会员登录记录</label><br />
<input name="dbs[]" type="checkbox" value="h_log_point1" id="h_log_point1" /><label for="h_log_point1">清空会员激活币明细记录</label><br />
<input name="dbs[]" type="checkbox" value="h_log_point2" id="h_log_point2" /><label for="h_log_point2">清空会员元明细记录</label><br />
    </td>
  </tr>
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
