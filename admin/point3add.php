...
{
	global $db,$id;
	global $h_userName,$h_jifen,$h_about;
	
	$h_jifen = intval($h_jifen);
	
	if($h_userName == ''){HintAndBack("会员编号不能为空！",1);}
	if($h_jifen == 0){HintAndBack("数值不能为0！",1);}
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="tableborder">
  <tr>
    <td height="25" colspan="2" align="center" class="tdtitle">加减积分</td>
  </tr>
  ...
  <tr class="tdbottom" onMouseOver="javascript:this.className='tdbottomover';" onMouseOut="javascript:this.className='tdbottom';">
    <td align="center">积分数值</td>
    <td><input name="h_jifen" type="text" class="inputclass1" maxlength="25" value="" />
