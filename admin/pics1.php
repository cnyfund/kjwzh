...
(
	...
	(
		...
		"h_point2Day"=>array
		(
			"title"=>"每天生产元","type"=>"string","width"=>"","align"=>"center"
		)
		,
		"h_life"=>array
		(
		...
		"h_allMaxNum"=>array
		(
			"title"=>"农场最大存在","type"=>"string","width"=>"","align"=>"center"
		)
		,
		"action"=>array
		(
	...
	(
		...
		"h_point2Day"=>array
		(
			"title"=>"每天生产","control"=>"text","required"=>1,"tips"=>" 元",
			"attr"=>array
			(
		...
		"h_money"=>array
		(
			"title"=>"售价","control"=>"text","required"=>1,"tips"=>" 元",
			"attr"=>array
			(
				"class"=>"inputclass1","maxlength"=>"8"
			)
		...
		"h_allMaxNum"=>array
		(
			"title"=>"农场最大存在","control"=>"text","required"=>1,"tips"=>" 只",
			"attr"=>array
			(
				"class"=>"inputclass1","maxlength"=>"8"
			)
