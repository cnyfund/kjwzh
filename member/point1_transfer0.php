...
<div class="panel panel-default">
  <div class="panel-heading">激活币转账</div>
...
?>
  ...
  您好! <strong><?php echo $rs['h_fullName']; ?></strong> (<?php echo $rs['h_userName']; ?>)会员. 您的目前暂不支持转出激活币<!--:<span id="mejihuobi"><?php echo $rs['h_point1']; ?></span>-->
  ...
  <div class="form-group">
    <!--<label for="x2" class="col-sm-2 control-label">会员账户</label>-->
    <div class="col-sm-10">
