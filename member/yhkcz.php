...
<link rel="stylesheet" href="\zjmcss\app_fundsManage.css">
<link rel="stylesheet" href="/zjmcss/layer.css">
<link type="text/css" rel="stylesheet" href="\zjmcss\funds.css">
<link type="text/css" rel="stylesheet" href="\zjmcss\iconfont.css">
<link type="text/css" rel="stylesheet" href="\zjmcss\mui.min.css">
<script async="" src="https://www.google-analytics.com/analytics.js"></script>
<script type="text/javascript" src="https://long81314.com/mobile/js/lib/jquery/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="https://long81314.com/js/layer/mobile/layer.js"></script>
<script type="text/javascript" src="https://long81314.com/mobile/js/clip.js"></script>
<script type="text/javascript" src="https://long81314.com/mobile/app/js/deposit.js?v=2233"></script>
...
<div class="skl_contens">
	...
	<div class="buttonStyle">
      ...
      <input type="image" class="head-icon-left" src="mod/images/common_back.png" style="border-width:0px;"></a>
...
<li><p class="tips red">仅本次有效，下次存款请重新获取</p></li>
    <li>
                                    ...
                                    <textarea rows="1" readonly="readonly" class="my-input" id="ccbankname">工商银行</textarea>
</span>
                                </li>
                                <li>
                                    <span class="left-title">收款银行卡号</span>
                                    <span class="right-txt">
                                        <textarea rows="1" readonly="readonly" class="my-input" id="ccaccountno">6212263602107311318</textarea>
                                ...
                                <li>
                                    ...
                                    <span class="right-txt">
                                        <textarea rows="1" readonly="readonly" class="my-input" id="ccaccountname">朱文峰</textarea>
                                ...
                                <li id="fuyan-box">
                                    ...
                                    <span class="right-txt">
                                        <textarea rows="1" readonly="readonly" class="my-input" id="ccmefuyan"><?php echo $rs['h_userName'];?></textarea>
