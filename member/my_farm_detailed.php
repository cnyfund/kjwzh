...
<div class="page-header long-header">
  <h3>理财商店 <small> 已买理财币(详单)</small></h3>
</div>
<div>
<ol class="breadcrumb">
  <li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <a href="/member/">主页</a></li>
  <li><a href="#">理财商店</a></li>
  <li class="active">已买理财币(详单)</li>
</ol>
</div>


<div class="panel panel-default">
  <div class="panel-heading">已买理财币(详单)</div>
...
<b>' , $val['h_title'] , '</b><br />
数量：' , $val['h_num'] , '<br />
每只每天产生' , $val['h_point2Day'] , '元<br />
每天总共可以产生：' , ($val['h_point2Day'] * $val['h_num']) , '元<br />
</td>
<td>
购买时间：' , $val['h_addTime'] , '<br />
物品寿命：' , date('Y-m-d',strtotime($val['h_endTime'])) , '<br />
已生产元：' , $val['h_settleLen'] , '天，共' , ($val['h_point2Day'] * $val['h_num'] * $val['h_settleLen']) , '元<br />
还可生产元：' , ($val['h_life'] - $val['h_settleLen']) , '天，共' , ($val['h_point2Day'] * $val['h_num'] * ($val['h_life'] - $val['h_settleLen'])) , '元<br />
</td>
</tr>';
		}
	}
