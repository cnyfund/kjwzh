...
function list_(){
	...
	$mid = 111;
	$total_count = $db->counter('t_log_login_member', "h_userName = '{$memberLogged_userName}'", 'id');
	$page = (int)$page;
	...
	$query = "select * from `t_log_login_member` where h_userName = '{$memberLogged_userName}' order by h_addTime desc,id desc LIMIT $from_record, $list_num";
