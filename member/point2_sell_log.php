...
<div class="page-header long-header">
  <h3>元管理 <small> 元卖出记录</small></h3>
</div>
<div>
<ol class="breadcrumb">
  <li><span class="glyphicon glyphicon-home" aria-hidden="true"></span> <a href="/member/">主页</a></li>
  <li><a href="#">元管理</a></li>
  <li class="active">元卖出记录</li>
</ol>
</div>


<div class="panel panel-default">
  <div class="panel-heading">元卖出列表</div>
   
<div class="panel-body">
<strong><span style="color:#F00;">警告:</span></strong><br>
<span style="color:#F00;">1.如果买家已把钱币打到你支付宝，而你超过12小时不确认收款，公司将没收你本次交易元</span><br>
</div>
 ...
 <script>
	...
	function jihuo_chedan2(c){
		...
		$.get("/member/bin.php?act=point2_sell_quit&id="+encodeURI(c),function(e){
			...
			if(e!=""){
				if(unescape(e)=='修改成功'){
					layer.msg("撤单成功,元已经返回到您的账户中,3秒后返回",function(){location.reload();});
					}else{
	...
	function jihuo_queren2(c){
		...
		$.get("/member/bin.php?act=point2_sell_confirm&id="+encodeURI(c),function(e){
			...
			if(e!=""){
				if(unescape(e)=='修改成功'){
					layer.msg("本次交易成功,元已经打入买家账户,3秒后返回",function(){location.reload();});
					}else{
					layer.msg(unescape(e))
					}
				}
