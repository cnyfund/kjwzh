...
<form class="form-horizontal">
   <div class="form-group">
    ...
    <div class="col-sm-9">
    <input class="form-control" id="x1" placeholder="玩家账号">
    [<a href="javascript:void(0)" onclick="$('#x1').val('[管理员]');">发给管理员点这里</a>]
    </div>
  </div>
 ...
 <script>
	...
	$("#xiexinxi").click(function(e) {
        indexdd=layer.open({type: 1,title:'写信息',area: '100%',skin: 'layui-layer-rim',content: $("#shouhuodizhi")});
    });
	function xiexxgo(t){
