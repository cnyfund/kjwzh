...
<body>
       <div>
  <img src="/images/lb2.jpg" width="100%" alt="">
</div>
...
function aq_2(){
 ...
 <input name="q3" type="hidden" value="<?php echo $q3; ?>">
	<div class="xlogin2 form-horizontal">
		<div class="lo1" style="color:#ffffff;">使用密保找回密码，第三步</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">玩家编号:</label>
			<div class="col-sm-8">
				<input class="form-control" id="username" name="username" readonly placeholder="您的玩家编号" value="<?php echo $username; ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">重置新密码:</label>
			<div class="col-sm-8">
...
function aq_1(){
 ...
 <form action="?type=aq&step=2" method="post">
	<div class="xlogin2 form-horizontal">
		<div class="lo1" style="color:#ffffff;">使用密保找回密码，第二步</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">玩家编号:</label>
			<div class="col-sm-8">
				<input class="form-control" id="username" name="username" readonly placeholder="您的玩家编号" value="<?php echo $username; ?>">
		...
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">密保问题1:</label>
			<div class="col-sm-8">
				<input class="form-control" id="a1" name="a1" readonly placeholder="您的密保问题1" value="<?php echo $rs['h_a1']; ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">答案1:</label>
			<div class="col-sm-8">
				<input class="form-control" id="q1" name="q1" placeholder="请填写您的答案1" value="">
			</div>
		</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">密保问题2:</label>
			<div class="col-sm-8">
				<input class="form-control" id="a2" name="a2" readonly placeholder="您的密保问题2" value="<?php echo $rs['h_a2']; ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">答案2:</label>
			<div class="col-sm-8">
				<input class="form-control" id="q2" name="q2" placeholder="请填写您的答案2" value="">
			</div>
		</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">密保问题3:</label>
			<div class="col-sm-8">
				<input class="form-control" id="a3" name="a3" readonly placeholder="您的密保问题3" value="<?php echo $rs['h_a3']; ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">答案3:</label>
			<div class="col-sm-8">
...
function aq(){
	...
	<div class="xlogin2 form-horizontal">
		<div class="lo1" style="color:#ffffff;">使用密保找回密码，第一步</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">玩家编号:</label>
			<div class="col-sm-8">
...
<form action="?type=qq&step=1" method="post">
	<div class="xlogin2 form-horizontal">
		<div class="lo1" style="color:#ffffff;">使用QQ找回密码，第一步</div>
		<div class="form-group">
			<label for="username" class="col-sm-4 control-label" style="color:#ffffff;">玩家编号:</label>
			<div class="col-sm-8">
				<input class="form-control" id="username" name="username" placeholder="请输入您的手机号码" value="">
...
function main(){
	?>
<div class="xlogin2 form-horizontal">
		<div class="lo1" style="color:#ffffff;">请选择找回密码类型</div>	
		<div class="form-group" style="padding-left:30px;">
			<div class="col-sm-12"><button type="button" onClick="window.location.href='?type=aq'" class="btn btn-primary form-control">使用回答密保问题的方式找回</button></div>
					<BR>	<div class="col-sm-12">
					  <a href="/member/kf2.php">
					  <button type="button" class="btn btn-primary form-control">客服找回</button>
					  </a></div>
